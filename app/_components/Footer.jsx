...
function Footer() {
  ...
  <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
    ...
    we offer top-quality products at prices that fit your budget. Experience convenient 
    grocery shopping with locally sourced items delivered straight to your door.<br/>
    
    Contact us: 📞 (+91)0274 262 820
    </p>
